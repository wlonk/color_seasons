"""
Django settings for Color Seasons project.
...
SECRET_KEY = 'LoH<HC@;L]:L9r!bDf{feZmq*xqD&-Luv)XuNSBtXep]O-(^UV'
...
ROOT_URLCONF = 'color_seasons.urls'
...
WSGI_APPLICATION = 'color_seasons.wsgi.application'
...
DATABASES = {
    'default': dj_database_url.config(
        default='postgres://localhost/color_seasons',
    ),
}
...
AUTH_USER_MODEL = 'color_seasons.User'
